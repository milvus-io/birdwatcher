...
type ColumnInfo struct {
	...
	DataType             schemapb.DataType `protobuf:"varint,2,opt,name=data_type,json=dataType,proto3,enum=milvus.protov2.schema.DataType" json:"data_type,omitempty"`
...
type UnaryRangeExpr struct {
	...
	Op                   OpType        `protobuf:"varint,2,opt,name=op,proto3,enum=milvus.protov2.plan.OpType" json:"op,omitempty"`
...
type CompareExpr struct {
	...
	Op                   OpType      `protobuf:"varint,3,opt,name=op,proto3,enum=milvus.protov2.plan.OpType" json:"op,omitempty"`
	XXX_NoUnkeyedLiteral struct{}    `json:"-"`
	XXX_unrecognized     []byte      `json:"-"`
	XXX_sizecache        int32       `json:"-"`
}
...
type UnaryExpr struct {
	Op                   UnaryExpr_UnaryOp `protobuf:"varint,1,opt,name=op,proto3,enum=milvus.protov2.plan.UnaryExpr_UnaryOp" json:"op,omitempty"`
...
type BinaryExpr struct {
	Op                   BinaryExpr_BinaryOp `protobuf:"varint,1,opt,name=op,proto3,enum=milvus.protov2.plan.BinaryExpr_BinaryOp" json:"op,omitempty"`
...
type BinaryArithOp struct {
	ColumnInfo           *ColumnInfo   `protobuf:"bytes,1,opt,name=column_info,json=columnInfo,proto3" json:"column_info,omitempty"`
	ArithOp              ArithOpType   `protobuf:"varint,2,opt,name=arith_op,json=arithOp,proto3,enum=milvus.protov2.plan.ArithOpType" json:"arith_op,omitempty"`
...
type BinaryArithExpr struct {
	...
	Op                   ArithOpType `protobuf:"varint,3,opt,name=op,proto3,enum=milvus.protov2.plan.ArithOpType" json:"op,omitempty"`
	XXX_NoUnkeyedLiteral struct{}    `json:"-"`
	XXX_unrecognized     []byte      `json:"-"`
	XXX_sizecache        int32       `json:"-"`
}
...
type BinaryArithOpEvalRangeExpr struct {
	...
	ArithOp              ArithOpType   `protobuf:"varint,2,opt,name=arith_op,json=arithOp,proto3,enum=milvus.protov2.plan.ArithOpType" json:"arith_op,omitempty"`
	RightOperand         *GenericValue `protobuf:"bytes,3,opt,name=right_operand,json=rightOperand,proto3" json:"right_operand,omitempty"`
	Op                   OpType        `protobuf:"varint,4,opt,name=op,proto3,enum=milvus.protov2.plan.OpType" json:"op,omitempty"`
...
func init() {
	proto.RegisterEnum("milvus.protov2.plan.OpType", OpType_name, OpType_value)
	proto.RegisterEnum("milvus.protov2.plan.ArithOpType", ArithOpType_name, ArithOpType_value)
	proto.RegisterEnum("milvus.protov2.plan.UnaryExpr_UnaryOp", UnaryExpr_UnaryOp_name, UnaryExpr_UnaryOp_value)
	proto.RegisterEnum("milvus.protov2.plan.BinaryExpr_BinaryOp", BinaryExpr_BinaryOp_name, BinaryExpr_BinaryOp_value)
	proto.RegisterType((*GenericValue)(nil), "milvus.protov2.plan.GenericValue")
	proto.RegisterType((*QueryInfo)(nil), "milvus.protov2.plan.QueryInfo")
	proto.RegisterType((*ColumnInfo)(nil), "milvus.protov2.plan.ColumnInfo")
	proto.RegisterType((*ColumnExpr)(nil), "milvus.protov2.plan.ColumnExpr")
	proto.RegisterType((*ValueExpr)(nil), "milvus.protov2.plan.ValueExpr")
	proto.RegisterType((*UnaryRangeExpr)(nil), "milvus.protov2.plan.UnaryRangeExpr")
	proto.RegisterType((*BinaryRangeExpr)(nil), "milvus.protov2.plan.BinaryRangeExpr")
	proto.RegisterType((*CompareExpr)(nil), "milvus.protov2.plan.CompareExpr")
	proto.RegisterType((*TermExpr)(nil), "milvus.protov2.plan.TermExpr")
	proto.RegisterType((*UnaryExpr)(nil), "milvus.protov2.plan.UnaryExpr")
	proto.RegisterType((*BinaryExpr)(nil), "milvus.protov2.plan.BinaryExpr")
	proto.RegisterType((*BinaryArithOp)(nil), "milvus.protov2.plan.BinaryArithOp")
	proto.RegisterType((*BinaryArithExpr)(nil), "milvus.protov2.plan.BinaryArithExpr")
	proto.RegisterType((*BinaryArithOpEvalRangeExpr)(nil), "milvus.protov2.plan.BinaryArithOpEvalRangeExpr")
	proto.RegisterType((*Expr)(nil), "milvus.protov2.plan.Expr")
	proto.RegisterType((*VectorANNS)(nil), "milvus.protov2.plan.VectorANNS")
	proto.RegisterType((*PlanNode)(nil), "milvus.protov2.plan.PlanNode")
}
...
var fileDescriptor_2d655ab2f7683c23 = []byte{
	...
	,
}
