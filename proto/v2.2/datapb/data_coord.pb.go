...
var ImportTaskStateV2_name = map[int32]string{
	0: "None",
	1: "Pending",
	2: "InProgress",
	3: "Failed",
...
var ImportTaskStateV2_value = map[string]int32{
	"None":       0,
	"Pending":    1,
	"InProgress": 2,
	"Failed":     3,
...
func (x ImportTaskStateV2) String() string {
	return proto.EnumName(ImportTaskStateV2_name, int32(x))
}
...
var CompactionTaskState_name = map[int32]string{
	0: "unknown",
	1: "executing",
	2: "pipelining",
	3: "completed",
...
var CompactionTaskState_value = map[string]int32{
	"unknown":    0,
	"executing":  1,
	"pipelining": 2,
	"completed":  3,
...
func (x CompactionTaskState) String() string {
	return proto.EnumName(CompactionTaskState_name, int32(x))
}
...
func (m *VchannelInfo) GetPartitionStatsVersions() map[int64]int64 {
	if m != nil {
		return m.PartitionStatsVersions
	}
	return nil
}
...
func (m *SegmentInfo) GetPartitionStatsVersion() int64 {
	if m != nil {
		return m.PartitionStatsVersion
	}
	return 0
}

func (m *SegmentInfo) GetLastLevel() SegmentLevel {
	if m != nil {
		return m.LastLevel
	}
	return SegmentLevel_Legacy
...
func (m *SegmentInfo) GetLastPartitionStatsVersion() int64 {
	if m != nil {
		return m.LastPartitionStatsVersion
	}
	return 0
}

func (m *SegmentInfo) GetIsSorted() bool {
	if m != nil {
		return m.IsSorted
	}
	return false
...
func (m *Binlog) GetMemorySize() int64 {
	if m != nil {
		return m.MemorySize
	}
	return 0
...
func (m *CompactionStateRequest) GetPlanID() int64 {
	if m != nil {
		return m.PlanID
	}
	return 0
...
func (m *CompactionSegmentBinlogs) GetCollectionID() int64 {
	if m != nil {
		return m.CollectionID
	}
	return 0
...
func (m *CompactionSegmentBinlogs) GetPartitionID() int64 {
	if m != nil {
		return m.PartitionID
	}
	return 0
...
func (m *CompactionPlan) GetStartTime() int64 {
	if m != nil {
		return m.StartTime
	}
	return 0
...
func (m *CompactionPlan) GetSchema() *schemapb.CollectionSchema {
	if m != nil {
		return m.Schema
	}
	return nil
...
func (m *CompactionPlan) GetClusteringKeyField() int64 {
	if m != nil {
		return m.ClusteringKeyField
	}
	return 0
}

func (m *CompactionPlan) GetMaxSegmentRows() int64 {
	if m != nil {
		return m.MaxSegmentRows
	}
	return 0
}

func (m *CompactionPlan) GetPreferSegmentRows() int64 {
	if m != nil {
		return m.PreferSegmentRows
	}
	return 0
}

func (m *CompactionPlan) GetAnalyzeResultPath() string {
	if m != nil {
		return m.AnalyzeResultPath
	}
	return ""
}

func (m *CompactionPlan) GetAnalyzeSegmentIds() []int64 {
	if m != nil {
		return m.AnalyzeSegmentIds
	}
	return nil
}

func (m *CompactionPlan) GetState() int32 {
	if m != nil {
		return m.State
	}
	return 0
...
func (m *CompactionPlanResult) GetState() CompactionTaskState {
	if m != nil {
		return m.State
	}
...
func (m *CompactionPlanResult) GetType() CompactionType {
	if m != nil {
		return m.Type
	}
	return CompactionType_UndefinedCompaction
...
func (m *AlterCollectionRequest) GetDbID() int64 {
	if m != nil {
		return m.DbID
	}
	return 0
...
func (m *PreImportRequest) GetJobID() int64 {
	if m != nil {
		return m.JobID
	}
	return 0
...
func (m *PreImportRequest) GetImportFiles() []*internalpb.ImportFile {
	if m != nil {
...
func (m *PreImportRequest) GetOptions() []*commonpb.KeyValuePair {
	if m != nil {
		return m.Options
	}
	return nil
...
func (m *ImportRequest) GetJobID() int64 {
	if m != nil {
		return m.JobID
	}
	return 0
...
func (m *ImportRequest) GetPartitionIDs() []int64 {
	if m != nil {
		return m.PartitionIDs
	}
	return nil
...
func (m *ImportRequest) GetVchannels() []string {
	if m != nil {
		return m.Vchannels
	}
	return nil
...
func (m *ImportRequest) GetFiles() []*internalpb.ImportFile {
	if m != nil {
		return m.Files
	}
	return nil
...
func (m *ImportRequest) GetRequestSegments() []*ImportRequestSegment {
	if m != nil {
...
func (m *QueryPreImportRequest) GetJobID() int64 {
	if m != nil {
		return m.JobID
	}
	return 0
...
type PartitionImportStats struct {
	...
	PartitionDataSize    map[int64]int64 `protobuf:"bytes,2,rep,name=partition_data_size,json=partitionDataSize,proto3" json:"partition_data_size,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}        `json:"-"`
	XXX_unrecognized     []byte          `json:"-"`
	XXX_sizecache        int32           `json:"-"`
}

func (m *PartitionImportStats) Reset()         { *m = PartitionImportStats{} }
func (m *PartitionImportStats) String() string { return proto.CompactTextString(m) }
...
func (m *PartitionImportStats) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_PartitionImportStats.Unmarshal(m, b)
}
func (m *PartitionImportStats) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_PartitionImportStats.Marshal(b, m, deterministic)
}
func (m *PartitionImportStats) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PartitionImportStats.Merge(m, src)
}
func (m *PartitionImportStats) XXX_Size() int {
	return xxx_messageInfo_PartitionImportStats.Size(m)
}
func (m *PartitionImportStats) XXX_DiscardUnknown() {
	xxx_messageInfo_PartitionImportStats.DiscardUnknown(m)
}

var xxx_messageInfo_PartitionImportStats proto.InternalMessageInfo

func (m *PartitionImportStats) GetPartitionRows() map[int64]int64 {
	if m != nil {
...
func (m *PartitionImportStats) GetPartitionDataSize() map[int64]int64 {
	if m != nil {
		return m.PartitionDataSize
	}
	return nil
}
...
type ImportFileStats struct {
	...
	HashedStats          map[string]*PartitionImportStats `protobuf:"bytes,5,rep,name=hashed_stats,json=hashedStats,proto3" json:"hashed_stats,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}                         `json:"-"`
	XXX_unrecognized     []byte                           `json:"-"`
	XXX_sizecache        int32                            `json:"-"`
}
...
func (m *ImportFileStats) GetImportFile() *internalpb.ImportFile {
	if m != nil {
		return m.ImportFile
	}
	return nil
...
func (m *ImportFileStats) GetTotalMemorySize() int64 {
	if m != nil {
...
func (m *ImportFileStats) GetHashedStats() map[string]*PartitionImportStats {
	if m != nil {
		return m.HashedStats
	}
	return nil
}
...
func (m *QueryPreImportResponse) GetState() ImportTaskStateV2 {
	if m != nil {
		return m.State
	}
...
func (m *QueryImportRequest) GetJobID() int64 {
	if m != nil {
		return m.JobID
	}
	return 0
...
func (m *QueryImportRequest) GetQuerySlot() bool {
	if m != nil {
		return m.QuerySlot
	}
	return false
...
func (m *ImportSegmentInfo) GetDeltalogs() []*FieldBinlog {
	if m != nil {
		return m.Deltalogs
	}
	return nil
...
func (m *QueryImportResponse) GetState() ImportTaskStateV2 {
	if m != nil {
		return m.State
	}
	return ImportTaskStateV2_None
...
func (m *DropImportRequest) GetJobID() int64 {
	if m != nil {
		return m.JobID
	}
	return 0
...
func (m *ImportJob) GetJobID() int64 {
	if m != nil {
		return m.JobID
	}
	return 0
...
func (m *ImportJob) GetDbID() int64 {
	if m != nil {
		return m.DbID
	}
	return 0
...
func (m *ImportJob) GetCollectionID() int64 {
	if m != nil {
		return m.CollectionID
	}
	return 0
...
func (m *ImportJob) GetCollectionName() string {
	if m != nil {
		return m.CollectionName
	}
	return ""
...
func (m *ImportJob) GetPartitionIDs() []int64 {
	if m != nil {
		return m.PartitionIDs
	}
	return nil
...
func (m *ImportJob) GetVchannels() []string {
	if m != nil {
		return m.Vchannels
	}
	return nil
...
func (m *ImportJob) GetSchema() *schemapb.CollectionSchema {
	if m != nil {
		return m.Schema
	}
	return nil
...
func (m *ImportJob) GetTimeoutTs() uint64 {
	if m != nil {
		return m.TimeoutTs
	}
	return 0
...
func (m *ImportJob) GetCleanupTs() uint64 {
	if m != nil {
		return m.CleanupTs
	}
	return 0
...
func (m *ImportJob) GetRequestedDiskSize() int64 {
	if m != nil {
		return m.RequestedDiskSize
	}
	return 0
}

func (m *ImportJob) GetState() internalpb.ImportJobState {
	if m != nil {
		return m.State
	}
...
func (m *ImportJob) GetReason() string {
	if m != nil {
		return m.Reason
	}
	return ""
...
func (m *ImportJob) GetCompleteTime() string {
	if m != nil {
...
func (m *ImportJob) GetFiles() []*internalpb.ImportFile {
	if m != nil {
		return m.Files
	}
	return nil
...
func (m *ImportJob) GetOptions() []*commonpb.KeyValuePair {
	if m != nil {
		return m.Options
	}
	return nil
...
func (m *ImportJob) GetStartTime() string {
	if m != nil {
		return m.StartTime
	}
	return ""
...
func (m *PreImportTask) GetJobID() int64 {
	if m != nil {
		return m.JobID
	}
	return 0
...
func (m *PreImportTask) GetState() ImportTaskStateV2 {
	if m != nil {
		return m.State
	}
	return ImportTaskStateV2_None
...
func (m *ImportTaskV2) GetJobID() int64 {
	if m != nil {
		return m.JobID
	}
	return 0
...
func (m *ImportTaskV2) GetState() ImportTaskStateV2 {
	if m != nil {
		return m.State
	}
	return ImportTaskStateV2_None
...
func (m *ImportTaskV2) GetCompleteTime() string {
	if m != nil {
		return m.CompleteTime
	}
	return ""
...
func (m *ImportTaskV2) GetStatsSegmentIDs() []int64 {
	if m != nil {
		return m.StatsSegmentIDs
	}
	return nil
}
...
func (m *CompactionTask) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_CompactionTask.Unmarshal(m, b)
}
...
func (m *CompactionTask) XXX_Size() int {
	return xxx_messageInfo_CompactionTask.Size(m)
}
...
func (m *CompactionTask) GetPlanID() int64 {
	if m != nil {
		return m.PlanID
	}
	return 0
...
func (m *CompactionTask) GetTriggerID() int64 {
	if m != nil {
		return m.TriggerID
	}
	return 0
...
func (m *CompactionTask) GetCollectionID() int64 {
	if m != nil {
		return m.CollectionID
	}
	return 0
...
func (m *CompactionTask) GetPartitionID() int64 {
	if m != nil {
		return m.PartitionID
	}
	return 0
...
func (m *CompactionTask) GetChannel() string {
	if m != nil {
		return m.Channel
	}
	return ""
...
func (m *CompactionTask) GetType() CompactionType {
	if m != nil {
		return m.Type
	}
	return CompactionType_UndefinedCompaction
...
func (m *CompactionTask) GetState() CompactionTaskState {
	if m != nil {
		return m.State
	}
	return CompactionTaskState_unknown
...
func (m *CompactionTask) GetFailReason() string {
	if m != nil {
		return m.FailReason
	}
	return ""
...
func (m *CompactionTask) GetStartTime() int64 {
	if m != nil {
		return m.StartTime
	}
	return 0
...
func (m *CompactionTask) GetEndTime() int64 {
	if m != nil {
		return m.EndTime
	}
	return 0
...
func (m *CompactionTask) GetTimeoutInSeconds() int32 {
	if m != nil {
		return m.TimeoutInSeconds
	}
	return 0
...
func (m *CompactionTask) GetRetryTimes() int32 {
	if m != nil {
		return m.RetryTimes
	}
	return 0
...
func (m *CompactionTask) GetCollectionTtl() int64 {
	if m != nil {
		return m.CollectionTtl
	}
	return 0
...
func (m *CompactionTask) GetTotalRows() int64 {
	if m != nil {
		return m.TotalRows
	}
	return 0
...
func (m *CompactionTask) GetInputSegments() []int64 {
	if m != nil {
		return m.InputSegments
	}
	return nil
}

func (m *CompactionTask) GetResultSegments() []int64 {
	if m != nil {
		return m.ResultSegments
	}
	return nil
}

func (m *CompactionTask) GetPos() *msgpb.MsgPosition {
	if m != nil {
		return m.Pos
	}
	return nil
...
func (m *CompactionTask) GetNodeID() int64 {
	if m != nil {
		return m.NodeID
	}
	return 0
...
func (m *CompactionTask) GetSchema() *schemapb.CollectionSchema {
	if m != nil {
		return m.Schema
	}
	return nil
...
func (m *CompactionTask) GetClusteringKeyField() *schemapb.FieldSchema {
	if m != nil {
		return m.ClusteringKeyField
	}
	return nil
...
func (m *CompactionTask) GetMaxSegmentRows() int64 {
	if m != nil {
		return m.MaxSegmentRows
	}
	return 0
...
func (m *CompactionTask) GetPreferSegmentRows() int64 {
	if m != nil {
		return m.PreferSegmentRows
	}
	return 0
...
func (m *CompactionTask) GetAnalyzeTaskID() int64 {
	if m != nil {
		return m.AnalyzeTaskID
	}
	return 0
}

func (m *CompactionTask) GetAnalyzeVersion() int64 {
	if m != nil {
		return m.AnalyzeVersion
	}
	return 0
}

func init() {
	proto.RegisterEnum("milvus.protov2.data.SegmentType", SegmentType_name, SegmentType_value)
	proto.RegisterEnum("milvus.protov2.data.SegmentLevel", SegmentLevel_name, SegmentLevel_value)
	proto.RegisterEnum("milvus.protov2.data.ChannelWatchState", ChannelWatchState_name, ChannelWatchState_value)
	proto.RegisterEnum("milvus.protov2.data.CompactionType", CompactionType_name, CompactionType_value)
	proto.RegisterEnum("milvus.protov2.data.ImportTaskStateV2", ImportTaskStateV2_name, ImportTaskStateV2_value)
	proto.RegisterEnum("milvus.protov2.data.GcCommand", GcCommand_name, GcCommand_value)
	proto.RegisterEnum("milvus.protov2.data.CompactionTaskState", CompactionTaskState_name, CompactionTaskState_value)
	proto.RegisterType((*Empty)(nil), "milvus.protov2.data.Empty")
	proto.RegisterType((*FlushRequest)(nil), "milvus.protov2.data.FlushRequest")
	proto.RegisterType((*FlushResponse)(nil), "milvus.protov2.data.FlushResponse")
	proto.RegisterMapType((map[string]*msgpb.MsgPosition)(nil), "milvus.protov2.data.FlushResponse.ChannelCpsEntry")
	proto.RegisterType((*FlushChannelsRequest)(nil), "milvus.protov2.data.FlushChannelsRequest")
	proto.RegisterType((*SegmentIDRequest)(nil), "milvus.protov2.data.SegmentIDRequest")
	proto.RegisterType((*AssignSegmentIDRequest)(nil), "milvus.protov2.data.AssignSegmentIDRequest")
	proto.RegisterType((*SegmentIDAssignment)(nil), "milvus.protov2.data.SegmentIDAssignment")
	proto.RegisterType((*AssignSegmentIDResponse)(nil), "milvus.protov2.data.AssignSegmentIDResponse")
	proto.RegisterType((*GetSegmentStatesRequest)(nil), "milvus.protov2.data.GetSegmentStatesRequest")
	proto.RegisterType((*SegmentStateInfo)(nil), "milvus.protov2.data.SegmentStateInfo")
	proto.RegisterType((*GetSegmentStatesResponse)(nil), "milvus.protov2.data.GetSegmentStatesResponse")
	proto.RegisterType((*GetSegmentInfoRequest)(nil), "milvus.protov2.data.GetSegmentInfoRequest")
	proto.RegisterType((*GetSegmentInfoResponse)(nil), "milvus.protov2.data.GetSegmentInfoResponse")
	proto.RegisterMapType((map[string]*msgpb.MsgPosition)(nil), "milvus.protov2.data.GetSegmentInfoResponse.ChannelCheckpointEntry")
	proto.RegisterType((*GetInsertBinlogPathsRequest)(nil), "milvus.protov2.data.GetInsertBinlogPathsRequest")
	proto.RegisterType((*GetInsertBinlogPathsResponse)(nil), "milvus.protov2.data.GetInsertBinlogPathsResponse")
	proto.RegisterType((*GetCollectionStatisticsRequest)(nil), "milvus.protov2.data.GetCollectionStatisticsRequest")
	proto.RegisterType((*GetCollectionStatisticsResponse)(nil), "milvus.protov2.data.GetCollectionStatisticsResponse")
	proto.RegisterType((*GetPartitionStatisticsRequest)(nil), "milvus.protov2.data.GetPartitionStatisticsRequest")
	proto.RegisterType((*GetPartitionStatisticsResponse)(nil), "milvus.protov2.data.GetPartitionStatisticsResponse")
	proto.RegisterType((*GetSegmentInfoChannelRequest)(nil), "milvus.protov2.data.GetSegmentInfoChannelRequest")
	proto.RegisterType((*VchannelInfo)(nil), "milvus.protov2.data.VchannelInfo")
	proto.RegisterMapType((map[int64]int64)(nil), "milvus.protov2.data.VchannelInfo.PartitionStatsVersionsEntry")
	proto.RegisterType((*WatchDmChannelsRequest)(nil), "milvus.protov2.data.WatchDmChannelsRequest")
	proto.RegisterType((*FlushSegmentsRequest)(nil), "milvus.protov2.data.FlushSegmentsRequest")
	proto.RegisterType((*SegmentMsg)(nil), "milvus.protov2.data.SegmentMsg")
	proto.RegisterType((*SegmentInfo)(nil), "milvus.protov2.data.SegmentInfo")
	proto.RegisterType((*SegmentStartPosition)(nil), "milvus.protov2.data.SegmentStartPosition")
	proto.RegisterType((*SaveBinlogPathsRequest)(nil), "milvus.protov2.data.SaveBinlogPathsRequest")
	proto.RegisterType((*CheckPoint)(nil), "milvus.protov2.data.CheckPoint")
	proto.RegisterType((*DeltaLogInfo)(nil), "milvus.protov2.data.DeltaLogInfo")
	proto.RegisterType((*ChannelStatus)(nil), "milvus.protov2.data.ChannelStatus")
	proto.RegisterType((*DataNodeInfo)(nil), "milvus.protov2.data.DataNodeInfo")
	proto.RegisterType((*SegmentBinlogs)(nil), "milvus.protov2.data.SegmentBinlogs")
	proto.RegisterType((*FieldBinlog)(nil), "milvus.protov2.data.FieldBinlog")
	proto.RegisterType((*Binlog)(nil), "milvus.protov2.data.Binlog")
	proto.RegisterType((*GetRecoveryInfoResponse)(nil), "milvus.protov2.data.GetRecoveryInfoResponse")
	proto.RegisterType((*GetRecoveryInfoRequest)(nil), "milvus.protov2.data.GetRecoveryInfoRequest")
	proto.RegisterType((*GetRecoveryInfoResponseV2)(nil), "milvus.protov2.data.GetRecoveryInfoResponseV2")
	proto.RegisterType((*GetRecoveryInfoRequestV2)(nil), "milvus.protov2.data.GetRecoveryInfoRequestV2")
	proto.RegisterType((*GetSegmentsByStatesRequest)(nil), "milvus.protov2.data.GetSegmentsByStatesRequest")
	proto.RegisterType((*GetSegmentsByStatesResponse)(nil), "milvus.protov2.data.GetSegmentsByStatesResponse")
	proto.RegisterType((*GetFlushedSegmentsRequest)(nil), "milvus.protov2.data.GetFlushedSegmentsRequest")
	proto.RegisterType((*GetFlushedSegmentsResponse)(nil), "milvus.protov2.data.GetFlushedSegmentsResponse")
	proto.RegisterType((*SegmentFlushCompletedMsg)(nil), "milvus.protov2.data.SegmentFlushCompletedMsg")
	proto.RegisterType((*ChannelWatchInfo)(nil), "milvus.protov2.data.ChannelWatchInfo")
	proto.RegisterType((*CompactionStateRequest)(nil), "milvus.protov2.data.CompactionStateRequest")
	proto.RegisterType((*SyncSegmentsRequest)(nil), "milvus.protov2.data.SyncSegmentsRequest")
	proto.RegisterType((*CompactionSegmentBinlogs)(nil), "milvus.protov2.data.CompactionSegmentBinlogs")
	proto.RegisterType((*CompactionPlan)(nil), "milvus.protov2.data.CompactionPlan")
	proto.RegisterType((*CompactionSegment)(nil), "milvus.protov2.data.CompactionSegment")
	proto.RegisterType((*CompactionPlanResult)(nil), "milvus.protov2.data.CompactionPlanResult")
	proto.RegisterType((*CompactionStateResponse)(nil), "milvus.protov2.data.CompactionStateResponse")
	proto.RegisterType((*SegmentFieldBinlogMeta)(nil), "milvus.protov2.data.SegmentFieldBinlogMeta")
	proto.RegisterType((*WatchChannelsRequest)(nil), "milvus.protov2.data.WatchChannelsRequest")
	proto.RegisterType((*WatchChannelsResponse)(nil), "milvus.protov2.data.WatchChannelsResponse")
	proto.RegisterType((*SetSegmentStateRequest)(nil), "milvus.protov2.data.SetSegmentStateRequest")
	proto.RegisterType((*SetSegmentStateResponse)(nil), "milvus.protov2.data.SetSegmentStateResponse")
	proto.RegisterType((*DropVirtualChannelRequest)(nil), "milvus.protov2.data.DropVirtualChannelRequest")
	proto.RegisterType((*DropVirtualChannelSegment)(nil), "milvus.protov2.data.DropVirtualChannelSegment")
	proto.RegisterType((*DropVirtualChannelResponse)(nil), "milvus.protov2.data.DropVirtualChannelResponse")
	proto.RegisterType((*UpdateSegmentStatisticsRequest)(nil), "milvus.protov2.data.UpdateSegmentStatisticsRequest")
	proto.RegisterType((*UpdateChannelCheckpointRequest)(nil), "milvus.protov2.data.UpdateChannelCheckpointRequest")
	proto.RegisterType((*ResendSegmentStatsRequest)(nil), "milvus.protov2.data.ResendSegmentStatsRequest")
	proto.RegisterType((*ResendSegmentStatsResponse)(nil), "milvus.protov2.data.ResendSegmentStatsResponse")
	proto.RegisterType((*MarkSegmentsDroppedRequest)(nil), "milvus.protov2.data.MarkSegmentsDroppedRequest")
	proto.RegisterType((*SegmentReferenceLock)(nil), "milvus.protov2.data.SegmentReferenceLock")
	proto.RegisterType((*AlterCollectionRequest)(nil), "milvus.protov2.data.AlterCollectionRequest")
	proto.RegisterType((*GcConfirmRequest)(nil), "milvus.protov2.data.GcConfirmRequest")
	proto.RegisterType((*GcConfirmResponse)(nil), "milvus.protov2.data.GcConfirmResponse")
	proto.RegisterType((*ReportDataNodeTtMsgsRequest)(nil), "milvus.protov2.data.ReportDataNodeTtMsgsRequest")
	proto.RegisterType((*GetFlushStateRequest)(nil), "milvus.protov2.data.GetFlushStateRequest")
	proto.RegisterType((*ChannelOperationsRequest)(nil), "milvus.protov2.data.ChannelOperationsRequest")
	proto.RegisterType((*ChannelOperationProgressResponse)(nil), "milvus.protov2.data.ChannelOperationProgressResponse")
	proto.RegisterType((*PreImportRequest)(nil), "milvus.protov2.data.PreImportRequest")
	proto.RegisterType((*AutoIDRange)(nil), "milvus.protov2.data.autoIDRange")
	proto.RegisterType((*ImportRequestSegment)(nil), "milvus.protov2.data.ImportRequestSegment")
	proto.RegisterType((*ImportRequest)(nil), "milvus.protov2.data.ImportRequest")
	proto.RegisterType((*QueryPreImportRequest)(nil), "milvus.protov2.data.QueryPreImportRequest")
	proto.RegisterType((*PartitionImportStats)(nil), "milvus.protov2.data.PartitionImportStats")
	proto.RegisterMapType((map[int64]int64)(nil), "milvus.protov2.data.PartitionImportStats.PartitionDataSizeEntry")
	proto.RegisterMapType((map[int64]int64)(nil), "milvus.protov2.data.PartitionImportStats.PartitionRowsEntry")
	proto.RegisterType((*ImportFileStats)(nil), "milvus.protov2.data.ImportFileStats")
	proto.RegisterMapType((map[string]*PartitionImportStats)(nil), "milvus.protov2.data.ImportFileStats.HashedStatsEntry")
	proto.RegisterType((*QueryPreImportResponse)(nil), "milvus.protov2.data.QueryPreImportResponse")
	proto.RegisterType((*QueryImportRequest)(nil), "milvus.protov2.data.QueryImportRequest")
	proto.RegisterType((*ImportSegmentInfo)(nil), "milvus.protov2.data.ImportSegmentInfo")
	proto.RegisterType((*QueryImportResponse)(nil), "milvus.protov2.data.QueryImportResponse")
	proto.RegisterType((*DropImportRequest)(nil), "milvus.protov2.data.DropImportRequest")
	proto.RegisterType((*ImportJob)(nil), "milvus.protov2.data.ImportJob")
	proto.RegisterType((*PreImportTask)(nil), "milvus.protov2.data.PreImportTask")
	proto.RegisterType((*ImportTaskV2)(nil), "milvus.protov2.data.ImportTaskV2")
	proto.RegisterType((*GcControlRequest)(nil), "milvus.protov2.data.GcControlRequest")
	proto.RegisterType((*CompactionTask)(nil), "milvus.protov2.data.CompactionTask")
}
...
var fileDescriptor_82cd95f524594f49 = []byte{
	...
	,
}
...
func (*UnimplementedDataCoordServer) ImportV2(ctx context.Context, req *internalpb.ImportRequestInternal) (*internalpb.ImportResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ImportV2 not implemented")
}
func (*UnimplementedDataCoordServer) GetImportProgress(ctx context.Context, req *internalpb.GetImportProgressRequest) (*internalpb.GetImportProgressResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetImportProgress not implemented")
}
func (*UnimplementedDataCoordServer) ListImports(ctx context.Context, req *internalpb.ListImportsRequestInternal) (*internalpb.ListImportsResponse, error) {
